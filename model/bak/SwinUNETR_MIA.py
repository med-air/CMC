...
class SwinUNETR(nn.Module):
    ...
    def __init__(
        ...
        self._check_input_size(img_size)
        self.conv2 = nn.ConvTranspose3d(in_channels=14, out_channels=14, kernel_size=64, stride=32, padding=16,
                                   output_padding=0)
    ...
    def forward(self, x_in):
        ...
        dec3 = self.decoder5(MIA_feat, hidden_states_out[3])
