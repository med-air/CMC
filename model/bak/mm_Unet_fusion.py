...
class UNet3D(nn.Module):
    ...
    def forward(self, x1,x2):## x1, x2 are two different modality data, such as CT and MRI
        ...
        fuse_feat = self.fusion_layer(MIA_feat_x1, MIA_feat_x2)
        MIA_x1 = fuse_feat + MIA_feat_x1
        MIA_x2 = fuse_feat + MIA_feat_x2

        ## decode for modality data from x1
        self.out_up_256_x1 = self.up_tr256(MIA_x1,self.skip_out256_x1)
        ...
        self.final_out = self.out_x1 + self.out_x2

        # return x1_img_F_ds, x2_img_F_ds, self.out_x1, self.out_x2,
        return self.out_x1, self.out_x2, self.final_out
