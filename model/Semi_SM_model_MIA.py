...
class Semi_SM_model(nn.Module):
    ...
    def forward(self, CT_img,MRI_img):
        ...
        # if CT_img_F_mia.shape[2] != MRI_img_F_mia.shape[2]:
        #     m_batchsize, C, depth, height, width = CT_img_F_mia.size()
        #     MRI_img_F_mia = F.interpolate(CT_img_F_mia, size=(depth, height, width), mode='trilinear',
        #                              align_corners=True)
