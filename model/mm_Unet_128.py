...
class MIA_Module(nn.Module):
    ...
    def forward(self, x):
        ...
        img_F_ds = F.interpolate(img_F_ds, size=(self.img_size, self.img_size, self.img_size), mode='trilinear', align_corners=True)
        ### MIA module #######
        ...
        img_F_mia_fusion = F.interpolate(img_F_mia_fusion, size=(self.img_size, self.img_size, self.img_size), mode='trilinear', align_corners=True)
...
class UNet3D(nn.Module):
    ...
    def __init__(self, n_class=14, img_size=128, act='relu'):
        ...
        self.MIA_module = MIA_Module(14, img_size)
    ...
    def forward(self, x1):## x1, x2 are two different modality data, such as CT and MRI
        ...
        self.out_up_256_x1 = self.up_tr256(self.out512_x1,self.skip_out256_x1)
